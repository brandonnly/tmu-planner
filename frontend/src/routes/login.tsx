			...
			>
				<div className="flex flex-col items-center gap-6">
					...
					<Button
						disabled={!verified}
						variant="outline"
						className="w-[300px] h-11 text-base gap-3 bg-white hover:bg-gray-100 text-gray-500 hover:text-gray-700 shadow-sm hover:shadow-md transition-all duration-200"
